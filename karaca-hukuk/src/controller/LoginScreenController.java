    ...
    void login() {
        ...
        if (tcString.equals("") || password.equals("") || tcString.length() != 11) {
            ...
            try {
                ...
                createAlertDialog(Alert.AlertType.ERROR, "Hata", null, "T.C. kimlik numarası nümerik olmalıdır.")
                        .show();
            }
            ...
            if (tc != 0) {
                ...
                if (!list.isEmpty()) {
                    ...
                    // member not found
                    createAlertDialog(Alert.AlertType.INFORMATION, "Bilgi", null, "Böyle bir kullanıcı bulunamadı.").show();
                }
            } else {
